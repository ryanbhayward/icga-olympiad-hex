...
\begin{figure}[hbp]
\noindent\hfill\
\includegraphics[scale=1]{pix/11.mh3.eps}\hspace*{-1.5cm}\hfill\
\includegraphics[scale=]{pix/11.hm4.eps}\hspace*{-1.5cm}\hfill~
\caption{\Hite-\Mx\ Games 3-4. ~ ~ M-H 1-0 ~ ~ H-M 0-1}
\end{figure}
...
\includegraphics[scale=1]{pix/11.me2plus.eps}\hspace*{-1.2cm}\
\includegraphics[scale=1]{pix/11.em3plus.eps}\hspace*{-1.2cm}\
\caption{\Ec-\Mx\ Games 1-3. ~ ~ E-M 0-1. ~ ~ M-E 1-0 ~ ~ E-M 1-0}
\label{fig:EM1-3}
\end{figure}

\begin{figure}[hbp]
\includegraphics[scale=1]{pix/11.me4plus.eps}\hspace*{-1.2cm}\
\includegraphics[scale=1]{pix/11.me5plus.eps}\hspace*{-1.2cm}\
\includegraphics[scale=1]{pix/11.em6plus.eps}\hspace*{-1.2cm}\
\caption{\Ec-\Mx\ Games 4-6. ~ ~ M-E 1-0. ~ ~ M-E 0-1 ~ ~ E-M 1-0}
\end{figure}

\begin{figure}[hbp]
\includegraphics[scale=1]{pix/11.me7plus.eps}\hspace*{-1.2cm}\
\includegraphics[scale=1]{pix/11.em8plus.eps}\hspace*{-1.2cm}\
\includegraphics[scale=1]{pix/11.em9plus.eps}\hspace*{-1.2cm}\
\caption{\Ec-\Mx\ Games 7-9. M-E 0-1. ~ ~ E-M 0-1 ~ ~ E-M 0-1}
\end{figure}

\begin{figure}[hbp]
\includegraphics[scale=1]{pix/11.me10plus.eps}\hspace*{-1.2cm}\
\includegraphics[scale=1]{pix/11.me11plus.eps}\hspace*{-1.2cm}\
\includegraphics[scale=1]{pix/11.em12plus.eps}\hspace*{-1.2cm}\
