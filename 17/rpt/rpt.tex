...
See Figures~\ref{fig:EM11} and \ref{fig:EM13}.
...
\begin{figure}[hbp]
\noindent\hspace*{-.4cm}\
\includegraphics[scale=.9]{pix/13.me1plus.eps}\hspace*{-2cm}\
\includegraphics[scale=.9]{pix/13.em2plus.eps}\hspace*{-2cm}\
\includegraphics[scale=.9]{pix/13.me3plus.eps}

\noindent\hspace*{-.4cm}\
\includegraphics[scale=.9]{pix/13.em4plus.eps}\hspace*{-2cm}\
\includegraphics[scale=.9]{pix/13.me5plus.eps}\hspace*{-2cm}\
\includegraphics[scale=.9]{pix/13.em6plus.eps}\

\noindent\hspace*{-.4cm}\
\includegraphics[scale=.9]{pix/13.me7plus.eps}\hspace*{-2cm}\
