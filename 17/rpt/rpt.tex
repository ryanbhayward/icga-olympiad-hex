...
Fellow student Wu Tong (no relation to other Wu Tong) helped operate \Hent{}.
...
to win a game against \Ec{} or \Mx{}, which both
...
\begin{figure}[hbp]
\includegraphics[scale=1]{pix/11.mh1.eps}\hspace*{-1.2cm}\
\includegraphics[scale=1]{pix/11.hm2.eps}\hspace*{-1.2cm}\
\includegraphics[scale=1]{pix/11.hm3.eps}\hspace*{-1.2cm}\
\caption{\Hite-\Mx\ Games 1-3. ~ ~ M-H 1-0 ~ ~ H-M 0-1 ~ ~ H-M 0-1}
\end{figure}
...
The weak move 2.W[f5] is presumably due to a failure to recover
from poor initial rollouts; usually \Mx\ replies 2.W[g5].
...
feature turned off. It was clear from these games that the resulting search
