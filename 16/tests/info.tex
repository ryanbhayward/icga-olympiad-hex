...
\begin{document}
\noindent\
\includegraphics[scale=1.7]{data/pix/empty11.eps}\hspace*{-2cm}
\includegraphics[scale=1.7]{data/pix/empty11.eps}\vfill
...
\noindent\
\includegraphics[scale=1.7]{data/pix/empty11.eps}\hspace*{-2cm}
\includegraphics[scale=1.7]{data/pix/empty11.eps}
\newpage
\noindent\
\includegraphics[scale=1.5]{data/pix/empty13.eps}\hspace*{-2cm}
\includegraphics[scale=1.5]{data/pix/empty13.eps}
