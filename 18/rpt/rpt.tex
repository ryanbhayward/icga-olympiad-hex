...
%\pretitle{Pretitle}
\title{MoHex defeats Ezo in 2018 Hex competitions}
...
\end{frontmatter}
\markboth{Hayward, Gao and Takada}{Hex 2018: \Mx\ defeats \Eo}
...
There were two Hex competitions at the 
2018 Olympiad in New Taipei City,
board-size 11$\times$11 and 
board-size 13$\times$13.\footnote{\cite{H17olyrptsource} gives .sgf 
  game records and other source files for this report.
  \cite{Hexgui} gives an SGF (Smart Game Format) viewer.
  SGF was developed by \cite{SGF}.}
11$\times$11 is the original board size introduced by Piet Hein in 1942. 
All 1-move openings on 9$\times$9 Hex have been solved by
computers, as have two 10$\times$10 openings \cite{PawlH13}.
In recent years a 13$\times$13 competition ---
a size used by the Little Golem online Hex community \cite{LittleG} ---
was introduced.
...
and \Mx{} by Chao Gao, supervised by Ryan Hayward and Martin M\"{u}ller, 
from Canada, with the assistance of
Jakub Pawlewicz,
Ashley Herman,
Joseph Meleshko,
Jiahao Li,
...
Wai Yi Low,
Xutong Zhao,
Openings were picked  by Jakub Pawlewicz based
on his opening book program.
