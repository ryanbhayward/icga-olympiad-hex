...
%\pretitle{Pretitle}
\title{2018 Hex: ? wins 11x11, ? wins 13x13}
...
So, in recent years a 13$\times$13 competition ---
...
The 11$\times$11 contestants were TODO
\Hite{} by Ma Shengjie from China;
\Ec{} by Kei Takada, supervised by Masahito Yamamoto, from Japan;
and \Mx{} by Chao Gao, Jakub Pawlewicz TODO. 
built on top of MoHex 2.0 by Broderick Arneson, Ryan Hayward, Philip Henderson, Aja Huang, 
